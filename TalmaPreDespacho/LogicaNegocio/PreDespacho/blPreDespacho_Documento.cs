...
{
    public class blPreDespacho_Documento
    {
        public List<bePreDespacho_Documento> GetPreDespacho_Documentos(string ID_GUIA, int ID_ARCH, out beLogger logger)
        {
            ...
            try
            {
                daPreDespacho_Documento da = new daPreDespacho_Documento();
                ocol = da.GetPreDespacho_Documentos(ID_GUIA, ID_ARCH);
        ...
        public bool UpSert_PreDespacho_Documento(bePreDespacho_Documento be, out beLogger logger)
        {
            ...
            try
            {
                ...
                {
                    string Base = ConfigurationManager.AppSettings["DIR_IMG_PREDES"].ToString();
                    string Web = ConfigurationManager.AppSettings["WEB_IMG_PREDES"].ToString();
                ...
                daPreDespacho_Documento da = new daPreDespacho_Documento();
                queues.Add(da.UpSert_PreDespacho_Documento(be));
